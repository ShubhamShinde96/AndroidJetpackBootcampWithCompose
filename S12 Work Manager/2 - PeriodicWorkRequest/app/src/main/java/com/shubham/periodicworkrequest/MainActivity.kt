package com.shubham.periodicworkrequest
...
import com.shubham.workmanagerdemo1.CompressingWorker
import com.shubham.workmanagerdemo1.DownloadingWorker
import com.shubham.workmanagerdemo1.FilteringWorker
import com.shubham.workmanagerdemo1.UploadWorker
...
//            .enqueue()  // This is how we can use sequential chaining
    ...
    private fun setPeriodicWorkRequest() {
        ...
        val periodicWorkRequest = PeriodicWorkRequest
            .Builder(DownloadingWorker::class.java, 16, TimeUnit.MINUTES) // WorkManager has minimum period of 15 minutes
            .build()

        WorkManager.getInstance(applicationContext).enqueue(periodicWorkRequest)

        // Wait after clicking on start button for 16 minutes, and you'll see it executing once again, as this is periodic execution.
